...
Route::any('/item-master-list/edit/{id}', [ItemMasterController::class ,'edit'])->name('item-masters.edit');
...
Route::post('/item-masters/search',[ItemMasterController::class,'search'])->name('item-masters.search');
...
Route::get('/courts-complex-master', [CourtComplexController::class, 'create'])->name('courts.complex.master');
