                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 mb-3 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="location_code" id="location_code" placeholder="Location  Code" value="{{$item->location_code}}" oninput="validateLocationCode()" aria-label="Title">
                                ...
                                <div class="col-sm-4 mb-3 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="location_name" oninput="ValidateLocationName()" id="location_name" value="{{$item->location_name}}" placeholder="Location Name" aria-label="Title">
                                ...
                                <div class="col-sm-4 mb-3 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="location_short_name" id="location_short_name" value="{{$item->location_short_name}}" placeholder="Vendor Short Name" oninput="ValidateLocationShortName()" aria-label="Title">
                                ...
                                <div class="col-sm-4 mb-3 mt-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select" name="district" id="district">
                                            <option value="" {{$item->district == '' ? 'selected' : ''}}>- District -</option>
                                ...
                                <div class="col-sm-12 mb-3 mt-1">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="address" rows="3" placeholder="Address">{{$item->address}}</textarea>
                                    </div>
                                </div>
...
<<script>
    ...
    $.ajax({
    url: "{{ route('location.master.update', ['id' => $item->id]) }}", // Adjust the route with item ID parameter
    type: "POST",
    data: data,
    dataType: "JSON",
    processData: false,
