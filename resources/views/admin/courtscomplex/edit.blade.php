...
<div class="page-header">
    <h4 class=""> Court Complex Master </h4> <a href="{{route('courts.complex.list')}}" class=" "> <label class="badge badge-info"><i class="mdi mdi-apps"></i> Manage</label></a>
</div>
...
<script>
    $(document).ready(function() {
        $("#company_form_btn").click(function(e) {
            ...
            $.ajax({
                url: "{{ route('courts.complex.update', ['id' => $item->id]) }}", // Fix the URL here
                type: "POST",
                data: data,
                dataType: "JSON",
                processData: false,
