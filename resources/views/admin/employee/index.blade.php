...
<style>
    ...
    <div class="page-header">
        <h4 class="py-3"> EMPLOYEE MASTER LIST
 </h4>
    </div>
                        ...
                        <div class=" slider">
                            <div class="row">
                                ...
                                <div class="col-sm-4  text-end mt-2">
                                    <a href="{{route('employee.master')}}"><label class="badge badge-success"><i class="mdi  mdi-plus-circle-outline me-1"></i> Add</label></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label class="badge badge-info me-3">
                                            <i class="mdi mdi-reload btn-icon-prepend"><a href="{{ route('employee.master.edit', $item->id) }}">update</a></i>
                                        </label>
...
<script>
    $(document).ready(function() {
        ...
        $("#confirmDelete").click(function(e) {
            ...
            $.ajax({
                url: "{{ route('employee.master.delete', ['id' => $item->id ?? '']) }}", // Adjust the route with item ID parameter
                type: "POST",
                data: {
