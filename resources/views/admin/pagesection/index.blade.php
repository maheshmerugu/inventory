...
<div class="page-header">
    <h4 class="py-3">Page Section List</h4>
</div>
<div class="content-wrapper">
    <div class="col-12 grid-margin stretch-card">
        <div class="card badge-light">
            <div class="card-body">
                <form action="{{ route('pagesection.list') }}" method="GET">
                    <div class=" slider">
                        <div class="row">
                            ...
                            <div class="col-sm-4  text-end mt-2">
                                <a href="{{route('pagesection.create')}}"><label class="badge badge-success"><i class="mdi  mdi-plus-circle-outline me-1"></i> Add</label></a>
                            </div>
                        </div>
                    </div>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="badge badge-info me-3">
                                        <i class="mdi mdi-reload btn-icon-prepend"><a href="{{ route('pagesection.edit', $item->id) }}">update</a></i>
                                    </label>
...
<script>
    $(document).ready(function() {
        ...
        $("#confirmDelete").click(function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "{{ route('pagesection.delete', ['id' => $item->id ?? '']) }}",
                type: "POST",
                data: {
                    _method: 'POST',
                    _token: '{{ csrf_token() }}',
