                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <table class="table table" id="dynamicTable">
                                ...
                                <tr>
                                    <td><input type="text" name="court[0][name]" placeholder="Enter your Court  Name" class="form-control" /></td>
                                    <td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#add").click(function() {
            ++i;
            var newRow = $('<tr>\
                        <td><input type="text" name="court[' + i + '][name]" placeholder="Enter Court Name" class="form-control" /></td>\
