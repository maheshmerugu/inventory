                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select" name="group_name" id="group_name" value="{{$item->group_name}}">
                                            <option value="0">- Select Group -</option>
                                            <option value="1" {{$item->group_name == 'Article' ? 'selected' : ''}}>Article</option>
                                            <option value="2" {{$item->group_name == 'Video' ? 'selected' : ''}}>Video</option>
                                            <option value="3" {{$item->group_name == 'Interview QA' ? 'selected' : ''}}>Interview QA</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="item_code" class="form-control form-control-lg" id="item_code" placeholder="Item Code" value="{{$item->item_code}}" aria-label="Title" required oninput="validateItemCode()">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="item_name" class="form-control form-control-lg" id="item_name" placeholder="Enter item" value="{{$item->item_name}}" aria-label="KnowMore Url" required oninput="validateItemName()">
                                    </div>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select" name="pn" id="pn" onchange="validatePnSelection()">
                                            ...
                                            <option value="1" {{$item->pn == 1 ? 'selected' : ''}}>Yes</option>
                                            <option value="2" {{$item->pn == 2 ? 'selected' : ''}}>No</option>
                                            <option value="3" {{$item->pn == 3 ? 'selected' : ''}}>Interview QA</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select" name="critical" id="critical" onchange="validateCriticalSelection()">
                                            ...
                                            <option value="1" {{$item->critical == 1 ? 'selected' : ''}}>Yes</option>
                                            <option value="2" {{$item->critical == 2 ? 'selected' : ''}}>No</option>
                                            <option value="3" {{$item->critical == 3 ? 'selected' : ''}}>Interview QA</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <!-- <select class="form-control form-select" name="active" id="active" value="{{$item->status}}">
                                    ...
                                    <div id="activeError" class="text-danger" style="display:none;">Status is required</div>
                                </div>
