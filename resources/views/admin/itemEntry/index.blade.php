                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="badge badge-successs">
                                        ...
                                        if ($item->status !== null) {
                                            $statusText = $item->status == 1 ? 'Installed' : ($item->status == 0 ? 'Delivered' : '');
                                        }
                                ...
                                <td>
                                        ...
                                        <label class="badge badge-info me-3">
                                            <i class="mdi mdi-reload btn-icon-prepend"><a href="{{ route('items.edit', $item->id) }}">Update</a></i>
                                        </label>
