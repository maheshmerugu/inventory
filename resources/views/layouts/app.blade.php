                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basics" style="">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="{{route('item-masters')}}">Item Master</a></li>
                                ...
                                <li class="nav-item"> <a class="nav-link" href="{{route('courts.complex.list')}}">Court Complex</a></li>
